...
type Template struct {
	Name      string                 `mapstructure:"name,omitempty" yaml:"name,omitempty" json:"name,omitempty" toml:"name,omitempty"`                     // Name of the template 	// Names of the templates
	Action    string                 `mapstructure:"action" yaml:"action,omitempty" json:"action,omitempty" toml:"action,omitempty"`                       // Action to perform with the template
	...
	Target    string                 `mapstructure:"target" yaml:"target,omitempty" json:"target,omitempty" toml:"target,omitempty"`                       // Target of the template
	...
	Variables map[string]interface{} `mapstructure:"variables,omitempty" yaml:"variables,omitempty" json:"variables,omitempty" toml:"variables,omitempty"` // Variables of the template
}

...
type Configuration struct {
	...
	CustomKeybindings []CustomKeybinding     `mapstructure:"custom_keybindings,omitempty" yaml:"custom_keybindings,omitempty" json:"custom_keybindings,omitempty" toml:"custom_keybindings,omitempty"`
}
...
type CustomKeybinding struct {
	...
	Command string `mapstructure:"command" yaml:"command" json:"command" toml:"command"`
	Binding string `mapstructure:"binding" yaml:"binding" json:"binding" toml:"binding"`
}
